...
export const ACHIEVEMENTS = [
  ...
  { id: "fanclub", icon: "💖", title: "Fanclub", desc: "20 Karten von ein und demselben Illustrator" },
  { id: "pokedex_forscher", icon: "🔎", title: "Pokédex-Forscher", desc: "60 verschiedene Pokémon-Arten gesammelt" },
  { id: "elementmeister", icon: "⚡", title: "Elementmeister", desc: "Karten aus 9 verschiedenen Pokémon-Typen" },
...
function computeProgress(userId) {
  ...
  return {
    ...
    fanclub: { current: maxArtistCount, target: 20 },
    pokedex_forscher: { current: dexSet.size, target: 60 },
    elementmeister: { current: typeSet.size, target: 9 },
