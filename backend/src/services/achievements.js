...
export const ACHIEVEMENTS = [
  ...
  { id: "kleiner_schatz", icon: "📦", title: "Kleiner Schatz", desc: "50 Karten in deiner Sammlung" },
  { id: "grosse_sammlung", icon: "🏰", title: "Große Sammlung", desc: "500 Karten in deiner Sammlung" },
  { id: "schatzkammer", icon: "💎", title: "Schatzkammer", desc: "2.500 Karten in deiner Sammlung" },
  { id: "entdecker", icon: "🗺️", title: "Entdecker", desc: "Karten aus 15 verschiedenen Sets" },
  { id: "weltenbummler", icon: "🌍", title: "Weltenbummler", desc: "Karten aus 40 verschiedenen Sets" },
  ...
  { id: "cleveres_naeschen", icon: "📈", title: "Cleveres Näschen", desc: "15 Karten mit Gewinn verkauft" },
  { id: "sprachtalent", icon: "🌐", title: "Sprachtalent", desc: "Mindestens 25 Karten in Deutsch und 25 in Englisch" },
  { id: "erste_bewertung", icon: "🥇", title: "Erste Bewertung", desc: "10 gegradete Karten (PSA, BGS, …) in der Sammlung" },
...
function computeProgress(userId) {
  ...
  return {
    ...
    kleiner_schatz: { current: totalQuantity, target: 50 },
    grosse_sammlung: { current: totalQuantity, target: 500 },
    schatzkammer: { current: totalQuantity, target: 2500 },
    entdecker: { current: sets.size, target: 15 },
    weltenbummler: { current: sets.size, target: 40 },
    ...
    cleveres_naeschen: { current: profitableSaleCount, target: 15 },
    sprachtalent: { current: minLangCount, target: 25 },
    erste_bewertung: { current: gradedCount, target: 10 },
